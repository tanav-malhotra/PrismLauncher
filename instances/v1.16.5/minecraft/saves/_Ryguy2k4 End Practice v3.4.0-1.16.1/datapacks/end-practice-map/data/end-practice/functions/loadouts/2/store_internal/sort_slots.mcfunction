...
execute store result score slotCount Loadouts run data get storage loadout_2 whole_inventory
...
function end-practice:loadouts/2/store_internal/check_offhand
function end-practice:loadouts/2/store_internal/check_armor
function end-practice:loadouts/2/store_internal/check_inventory
