...
execute store result storage loadout_2 whole_inventory[-1].Slot byte 1 run scoreboard players add slot Loadouts 106

# Move item into the offhand section:
data modify storage loadout_2 offhand append from storage loadout_2 whole_inventory[-1]
