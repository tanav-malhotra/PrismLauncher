...
execute store result score slotCount Loadouts run data get storage loadout_3 whole_inventory
...
function end-practice:loadouts/3/store_internal/check_offhand
