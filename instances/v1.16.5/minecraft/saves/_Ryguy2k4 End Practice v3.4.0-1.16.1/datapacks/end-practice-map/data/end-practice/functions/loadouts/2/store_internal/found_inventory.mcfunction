...
execute store result storage loadout_2 whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 9

# Move item into the inventory section:
data modify storage loadout_2 inventory append from storage loadout_2 whole_inventory[-1]
