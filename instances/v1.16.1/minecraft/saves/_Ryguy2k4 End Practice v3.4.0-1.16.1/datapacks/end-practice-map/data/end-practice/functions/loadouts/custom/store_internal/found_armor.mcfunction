...
execute store result storage loadout_custom whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 100

# Move item into the armor section:
data modify storage loadout_custom armor append from storage loadout_custom whole_inventory[-1]
