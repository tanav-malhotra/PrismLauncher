...
execute store result storage loadout_custom whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 9

# Move item into the inventory section:
data modify storage loadout_custom inventory append from storage loadout_custom whole_inventory[-1]
