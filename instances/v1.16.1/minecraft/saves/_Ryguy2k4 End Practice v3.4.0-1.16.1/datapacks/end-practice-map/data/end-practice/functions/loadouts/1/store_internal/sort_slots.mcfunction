...
execute store result score slotCount Loadouts run data get storage loadout_1 whole_inventory
...
function end-practice:loadouts/1/store_internal/check_offhand
