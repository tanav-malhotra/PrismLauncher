...
execute store result storage loadout_2 whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 100

# Move item into the armor section:
data modify storage loadout_2 armor append from storage loadout_2 whole_inventory[-1]
