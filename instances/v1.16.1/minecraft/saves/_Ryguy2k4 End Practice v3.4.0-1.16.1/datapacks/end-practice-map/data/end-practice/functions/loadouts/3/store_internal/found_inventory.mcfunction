...
execute store result storage loadout_3 whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 9

# Move item into the inventory section:
data modify storage loadout_3 inventory append from storage loadout_3 whole_inventory[-1]
...
function end-practice:loadouts/3/store_internal/check_inventory