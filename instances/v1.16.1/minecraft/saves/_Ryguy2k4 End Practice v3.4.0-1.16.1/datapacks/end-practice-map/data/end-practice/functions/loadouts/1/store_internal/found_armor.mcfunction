...
execute store result storage loadout_1 whole_inventory[-1].Slot byte 1 run scoreboard players remove slot Loadouts 100

# Move item into the armor section:
data modify storage loadout_1 armor append from storage loadout_1 whole_inventory[-1]
...
function end-practice:loadouts/1/store_internal/check_armor