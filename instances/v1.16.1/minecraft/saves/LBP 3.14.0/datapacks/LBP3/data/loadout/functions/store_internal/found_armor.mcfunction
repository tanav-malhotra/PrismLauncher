...
execute if score selected loadout.settings matches 1 run data modify storage loadout.1 armor append from storage loadout.global whole_inventory[-1]
execute if score selected loadout.settings matches 2 run data modify storage loadout.2 armor append from storage loadout.global whole_inventory[-1]
execute if score selected loadout.settings matches 3 run data modify storage loadout.3 armor append from storage loadout.global whole_inventory[-1]
